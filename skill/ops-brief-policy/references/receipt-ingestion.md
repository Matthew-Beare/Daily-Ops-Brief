...
- An enabled Tool Inventory authority is resolved through the private Authority Registry. A tool receipt may update it only after the base receipt record is safely stored. Tool Inventory is a downstream asset projection, not part of the purchase ledger's atomic commit.
