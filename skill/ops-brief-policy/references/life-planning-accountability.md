...
A failed reminder/scheduler does not erase routine/study state. Preserve canonical progress and use the Pants Filling With Shit Report for repeated scheduler/connector failures. Resume from canonical state after repair; never reconstruct history from what the assistant remembers saying.
