...
- Never send email automatically. Before any merchant/customer-service email, obtain explicit pre-send confirmation for that specific message. Do not delete Gmail without an explicit bounded request.
