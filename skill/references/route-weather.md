...
- The defaults in Travel Settings are an origin of Morristown, Tennessee, departure Friday at 4:30 PM Eastern, and a usual destination of Rialto / Southern California. The destination is a suggestion to confirm, never an assumption.
- The user's normal driving shift is 3:00 PM–3:00 AM Eastern. On the Saturday 2:45 AM ROAD brief, request a fresh current-location update for the active trip if the last observed location is missing or more than two hours old.
- The operation is team, straight through subject to HOS, with a truck governed at 68 mph. Do not equate governed speed with average speed and do not invent driver-level HOS timing. Stored route averages outrank naive distance/speed math.
