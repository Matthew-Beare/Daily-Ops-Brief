...
Personal Google currently uses Google Sheets/Drive plus optional Gmail/Calendar capabilities when verified. Microsoft 365, Apple/manual portability, Claude, Gemini, and institutional runtimes have no assumed feature parity and must be capability-checked.
