...
- Git is the durable source/version authority for code, policy, schemas, migrations, non-secret configuration, feature manifests, tests, onboarding, upstream provenance, and custom-feature lineage.
