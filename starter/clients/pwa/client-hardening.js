...
(() => {
  ...
  document.addEventListener("visibilitychange",()=>{ if(!document.hidden&&apiBase()) { loadProviders().catch(()=>{}); globalThis.MiraShell?.refreshHome?.().catch(()=>{}); globalThis.MiraExperienceV3?.refreshExperience?.().catch(()=>{}); } });
})();
