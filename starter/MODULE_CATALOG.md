...
Ask whether the user is working, retired, studying, caregiving, self-employed, mixed, or another pattern. For retired/nonworking users, surface appointments, household/admin, volunteering, hobbies, travel, family responsibilities, routines, projects, and documents without forcing work-mode machinery.
