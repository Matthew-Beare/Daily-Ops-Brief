# LyfeOS Interview Ledger and Fail-Forward Interview

The adaptive interview is a **durable workflow**, not a single uninterrupted chat. A user may change subjects, ask for immediate help, close the app, or return later. LyfeOS must preserve interview progress in the canonical structured state authority and continue without restarting or silently abandoning discovery.
