...
class BootstrapTests(unittest.TestCase):
    def test_example_renders_without_tokens(self) -> None:
        ...
        self.assertIn("CURRENT_STRUCTURED_STATE_AUTHORITY_SELECTED_BY_AUTHORITY_REGISTRY", rendered)
        ...
        self.assertIn("Google Sheets is the starter default structured provider", rendered)
        self.assertIn("another supported database can replace it", rendered)
