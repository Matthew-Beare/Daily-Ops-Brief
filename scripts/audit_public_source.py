...
The public repository may intentionally contain non-secret reference identifiers.
This audit blocks credential material and files that should never be source code.
