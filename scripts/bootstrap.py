...
CONFIG_KEYS = frozenset({
    "APPOINTMENT_RECONCILIATION", "APPOINTMENT_REMINDER_PROFILE",
    ...
    "DRIVE_ROOT", "EMAIL_PROVIDER", "EMAIL_RETENTION_POLICY",
    ...
    "PROFILE_MODEL", "PROVIDER_SPECIALTY_ENRICHMENT", "RECEIPT_SCOPE",
    ...
    "SYSTEM_NAME", "TIMEZONE", "UPSTREAM_PROVENANCE",
})
